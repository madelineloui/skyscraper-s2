...
python eval/eval_videollava.py \
 --json_path data/skyscraper_gdelt_sentinel/vqa/teochat_sentinel_event_grounding_val-sample.json \
 ...
 --lora_ckpt /home/gridsan/manderson/skyscraper-s2/out/finetune/video-llava/checkpoint-2320 \
 --output_csv out/vqa/grounding_videollava-ft-sample.csv