...
records = create_event_classification_json(
    labels_path="skyscraper_gdelt_sentinel/planetlabels.csv",
    imagery_dir="skyscraper_gdelt_sentinel/imagery",
)
with open("teochat_planet_event_classification.json", "w") as f:
...
#     imagery_dir="skyscraper_gdelt_sentinel/imagery",
# )
# with open("teochat_planet_event_detection.json", "w", encoding="utf-8") as f:
#     json.dump(records, f, indent=2)
...
#     imagery_dir="skyscraper_gdelt_sentinel/imagery",
# )
# with open("teochat_planet_event_description.json", "w", encoding="utf-8") as f:
#     json.dump(records, f, indent=2)
...
#     imagery_dir="skyscraper_gdelt_sentinel/imagery",
# )
# with open("teochat_planet_event_grounding.json", "w", encoding="utf-8") as f:
#     json.dump(records, f, indent=2)
